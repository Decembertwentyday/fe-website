  ...
  const handleTransfer = async () => {
    try {
      if (singer) {
        ...
        // Facet 链的交易方式：把兑换 calldata 编码后通过 transferEthscriptionFacet 发到 Facet 接收地址
        await evmService.etchMarket.transferEthscriptionFacet({
          singer,
          facetAddress: FACET_CONFIG.RECEIVE_ADDRESS, // Facet 链的固定接收地址 0x000...FacE7
      ...
      FacetSwapStore.setIsLoadingSync(false);
    }
  }
